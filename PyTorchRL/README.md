...
2. [Generative Adversarial Imitation Learning (GAIL)](https://arxiv.org/png/1606.03476.png)
...
* [Trust Region Policy Optimization (TRPO)](https://arxiv.org/png/1502.05477.png) -> [examples/trpo_gym.py](https://github.com/Khrylx/PyTorch-RL/blob/master/examples/trpo_gym.py)
* [Proximal Policy Optimization (PPO)](https://arxiv.org/png/1707.06347.png) -> [examples/ppo_gym.py](https://github.com/Khrylx/PyTorch-RL/blob/master/examples/ppo_gym.py)
* [Synchronous A3C (A2C)](https://arxiv.org/png/1602.01783.png) -> [examples/a2c_gym.py](https://github.com/Khrylx/PyTorch-RL/blob/master/examples/a2c_gym.py)
